...
class Product(BaseModel):
    ...
    sku: Annotated[
        ...
        Field(
            ...
            examples=["734-jhs-987-ik", "ksnj-939-lske-sle3"],
        ),
    ]
    ...
    description: Annotated[
        str, Field(max_length=200, description="Short product description")
    ]
    ...
    brand: Annotated[
        str, Field(min_length=2, max_length=40, examples=["Xiaomi", "Apple"])
    ]
    ...
    rating: Annotated[
        float, Field(ge=0, le=5, strict=True, description="Rating out of 5")
    ]
    ...
    image_url: Annotated[
        List[AnyUrl], Field(min_length=1, description="At least 1 imgage url")
    ]
